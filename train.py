...
import re
from datasets.mnist import get_mnist_trainset, get_mnist_test_set, get_camelyon_test_set_id, get_camelyon_test_set_ood, get_camelyon_just_test_shifted
...
def train_model(args, all_results_dict, mvtec_category=None):
    ...
    for _class in _classes:
        ...
        if not args['dataset'] in ['wbc1', 'wbc2', 'br35h', 'brats2015', 'mvtec', 'mnist', 'aptos', 'isic']:
