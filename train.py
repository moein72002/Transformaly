...
def train_model(args, all_results_dict, mvtec_category=None):
    ...
    if args['dataset'] == 'mvtec':
        ...
        _classes = [0]
    elif args['dataset'] in ['rsna', 'isic']:
        _classes = [0]
    ...
    for _class in _classes:
        ...
        if args['dataset'] == 'mvtec':
            ...
            ood_test_set = get_rsna_test_set_ood()
        elif args['dataset'] == 'isic':
            trainset = get_isic_trainset()
            testset = get_isic_test_set()
            ood_test_set = get_isic_test_set_ood()
        ...
        if not args['dataset'] in ['wbc1', 'wbc2', 'br35h', 'brats2015', 'mvtec', 'camelyon17', 'rsna', 'isic']:
