...
from datasets.mnist import get_mnist_trainset, get_camelyon_test_set_id, get_mnist_test_set, get_camelyon_test_set_ood, get_camelyon_just_test_shifted
...
def extract_fetures(base_path,
    ...
    for dataset in datasets:
        ...
        if manual_class_num_range is not None:
            ...
            if dataset in ['mvtec']:
                _classes = [0]
            elif dataset in ['br35h', 'brats2015', 'mnist', 'aptos', 'isic']:
                _classes = [0]
        ...
        for _class in _classes:
            ...
            for unimodal in unimodal_vals:
                ...
                assert dataset in ['mnist', 'aptos', 'isic', 'mvtec', 'br35h', 'brats2015', 'wbc1', 'wbc2', 'cifar10', 'cifar100', 'fmnist', 'cats_vs_dogs',
                ...
                if dataset == 'mvtec':
                    ...
                    trainset = get_mnist_trainset()
                    testset = get_mnist_test_set()
                    anomaly_targets = testset.labels
                ...
                if dataset in ['wbc1', 'wbc2', 'br35h', 'brats2015', 'mnist', 'aptos', 'isic']:
...
def train(model, best_model, args, dataloaders,
    ...
    for epoch in tqdm(range(1, args['epochs'] + 1)):
        ...
        if args['test_every_epoch'] and (epoch - 1) % args['eval_every'] == 0:
            ...
            if args['dataset'] in ['wbc1', 'wbc2', 'br35h', 'brats2015', 'mvtec', 'mnist', 'aptos', 'isic']:
                manual_class_num_range = None
            else:
...
def evaluate_method(args=None, BASE_PATH=None, _classes=None, mvtec_category=None):
    ...
    for _class in _classes:
        ...
        if args['dataset'] in ['wbc1', 'wbc2', 'br35h', 'brats2015', 'mnist', 'aptos', 'isic']:
        ...
        if args['dataset'] in ['wbc1', 'wbc2', 'br35h', 'mnist', 'brats2015', 'aptos', 'isic']:
        ...
        if args['dataset'] in ['wbc1', 'wbc2', 'br35h', 'mnist', 'aptos', 'isic', 'brats2015']:
