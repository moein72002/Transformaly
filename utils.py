...
def extract_fetures(base_path,
    ...
    for dataset in datasets:
        ...
        if manual_class_num_range is not None:
            ...
            if dataset in ['mvtec']:
                _classes = [0]
            elif dataset in ['br35h', 'brats2015', 'camelyon17', 'waterbird', 'isic']:
                _classes = [0]
        ...
        for _class in _classes:
            ...
            for unimodal in unimodal_vals:
                ...
                assert dataset in ['camelyon17', 'waterbird', 'isic', 'mvtec', 'br35h', 'brats2015', 'wbc1', 'wbc2', 'cifar10', 'cifar100', 'fmnist', 'cats_vs_dogs',
                ...
                if dataset == 'mvtec':
                    ...
                    anomaly_targets = testset.labels
                    just_testset = get_waterbird_just_test_shifted()
                    just_test_anomaly_targets = just_testset.labels
                elif dataset == 'isic':
                ...
                if dataset in ['wbc1', 'wbc2', 'br35h', 'brats2015', 'camelyon17', 'waterbird', 'isic']:
...
def train(model, best_model, args, dataloaders,
    ...
    for epoch in tqdm(range(1, args['epochs'] + 1)):
        ...
        if args['test_every_epoch'] and (epoch - 1) % args['eval_every'] == 0:
            ...
            if args['dataset'] in ['wbc1', 'wbc2', 'br35h', 'brats2015', 'mvtec', 'camelyon17', 'waterbird', 'isic']:
                manual_class_num_range = None
            else:
...
def evaluate_method(args=None, BASE_PATH=None, _classes=None, mvtec_category=None):
    ...
    for _class in _classes:
        ...
        if args['dataset'] in ['wbc1', 'wbc2', 'br35h', 'camelyon17', 'brats2015', 'waterbird', 'isic']:
        ...
        if args['dataset'] in ['wbc1', 'wbc2', 'br35h', 'camelyon17', 'waterbird', 'isic', 'brats2015']:
